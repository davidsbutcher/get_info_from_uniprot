...
out <-  NULL
for (i in seq_along(filelist)) {
  out = c(out, knitr::knit_expand("extras/report_template/protein-mass-histograms-02.Rmd"))
}
...
### Best Protein Hits - Mass Distributions by Fraction {.tabset .tabset-fade}

```{r, echo = FALSE}

out <-  NULL
for (i in seq_along(filelist)) {
  out = c(out, knitr::knit_expand("extras/report_template/protein-mass-histograms-03.Rmd"))
}
...
out <-  NULL
for (i in seq_along(filelist)) {
  out = c(out, knitr::knit_expand("extras/report_template/all-protein-hits.Rmd"))
}
